<template>
  <floating-ui
    ...
    :popper-class="`absolute bg-white dark:text-gray-50 dark:bg-gray-850 dark:border-gray-700 border shadow-lg rounded-md sds-theme-plaid:rounded-none ${sizeClass} ${zIndexClass}`"
