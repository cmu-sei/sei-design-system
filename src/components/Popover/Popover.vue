<template>
  <floating-ui
    ...
    :popper-class="`absolute bg-white dark:text-gray-50 dark:bg-gray-800 dark:border-gray-700 border shadow-lg rounded-md ${sizeClass} ${zIndexClass}`"
    arrow-class="absolute bg-white dark:bg-gray-800 dark:border-gray-700 border w-3 h-3 rotate-45"
