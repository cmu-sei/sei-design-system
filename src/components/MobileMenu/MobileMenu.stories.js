...
import SdsMobileMenuItem from '../MobileMenuItem/MobileMenuItem.vue';
...
export default {
  ...
  parameters: {
    docs: {
      ...
      description: {
        component: 'A Mobile Menu is a large, expandable drop-down container for global navigation links on complex websites.'
      }
    }
  },
