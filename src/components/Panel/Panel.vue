    ...
    <teleport to="body">
      ...
      >
        <div
          ...
          class="fixed flex flex-col inset-y-0  w-5/12 w-8/12 w-10/12 w-11/12 w-full bg-white overflow-y-scroll border rounded-lg shadow-xl dark:bg-gray-900 dark:border-gray-700"
