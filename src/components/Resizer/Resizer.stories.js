...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Beta: Allow an area to be resized (either vertically or horizontally) by clicking and dragging on the border.',
      },
    },
  },
...
const Template = (args) => ({
  ...
  template: `
    <sds-resizer v-bind="args" class="w-full">
      <div class="justify-start p-4 bg-teal-25 h-fit overflow-y-hidden">
