    ...
    >
      ...
      >
        <component
          ...
          role="menuitem"
          class="flex items-center gap-0.5 xl:gap-1 my-auto py-2 space-x border-b-2 group -mb-0.5 overflow-y-visible select-none shrink-0 text-sm xl:text-base focus:outline focus:outline-2"
