<template>
  ...
  >
    <div
      ...
      :class="{
        'bg-gray-50 dark:bg-gray-850 rounded-t sds-theme-plaid:rounded-none': type === 'folder'
      }"
    >
      <ul
        role="tablist"
      ...
      >
        ...
        >
          <component
            ...
            :class="{
              'tab text-sm inline-block rounded-t sds-theme-plaid:rounded-none py-2 px-4 font-semibold': type === 'folder',
