<template>
  <div
    data-id="sds-simple-application"
    ...
    <div class="flex grow shrink-0">
      ...
      <div class="bg-gray-25 dark:bg-black flex flex-col items-stretch grow min-w-0">
        <main class="grow pb-4">
          <div
            v-if="!hidePageHeader"
            class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 sticky top-0 z-40 flex flex-col gap-4 md:flex-row"
          >
