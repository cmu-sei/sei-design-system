<template>
  <div
    data-id="sds-badge"
    role="status"
    class="inline-flex items-center justify-center gap-1 tracking-wide max-w-full uppercase px-2 py-1 text-xs font-bold text-center text-ellipsis whitespace-nowrap overflow-hidden align-baseline rounded-sm sds-theme-plaid:rounded-none"
    :class="variantClass"
  >
    <!-- @slot Badge content.  -->
    <slot />
