      ...
      <template v-if="isAction(action) && !readonly">
        ...
        <template v-else-if="action === 'remove'">
          <button 
            ref="button" 
            type="button"
            class="flex flex-col items-center justify-center text-red-600 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-900 focus:outline-none focus-within:bg-red-50"
            :class="[buttonSizeClass]"
            @click.stop="remove"
          >
            <SdsSvgIcon
