import SdsActionDropdown from './ActionDropdown.vue';
...
export default {
  title: 'Components/Buttons/Dropdowns/Action Dropdown',
  parameters: {
    docs: {
      description: {
...
const Template = (args) => ({
  components: { SdsActionDropdown, SdsDropdownItem, SdsDropdownHeader, SdsDropdownDivider },
  setup() {
    return { args }
  },
  template: `
