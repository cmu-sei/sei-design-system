          ...
          <div class="ml-auto mt-auto relative">
            ...
            >
              <div
                v-if="open"
                ref="modal"
                class="absolute flex flex-col bottom-20 right-0 pointer-events-auto border border-gray-100 dark:border-gray-600 rounded-lg h-144 max-w-[32rem] w-[calc(100vw-2rem)] sm:w-[32rem] bg-white dark:bg-gray-900 shadow-lg"
