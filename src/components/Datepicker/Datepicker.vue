<template>
  <floating-ui
    ...
    placement="bottom"
    :disabled="disabled"
    :popper-class="`absolute bg-white border dark:text-gray-50 dark:bg-gray-800 dark:border-gray-700 shadow-lg rounded-md w-auto ${zIndexClass}`"
    arrow-class="absolute bg-white border dark:bg-gray-800 dark:border-gray-700 w-3 h-3 rotate-45"
