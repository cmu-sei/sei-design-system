import SdsApplication from './Application.vue';
...
export default {
  ...
  component: SdsApplication,
  argTypes: {}
};

const Template = (args) => ({
  components: { SdsApplication, SdsButton, SdsAvatar, SdsTooltip },
  setup() {
    return { args }
  },
  template: `
    <sds-application v-model="localValue" v-bind="args" @navigate="navigate">
