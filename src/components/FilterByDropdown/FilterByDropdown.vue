<template>
  <floating-ui
    ...
    :placement="placement"
    :popper-class="`absolute border shadow-lg rounded-md bg-gray-100 dark:border-gray-700 dark:bg-gray-800 w-72 ${zIndexClass}`"
    arrow-class="absolute bg-gray-100 border dark:border-gray-700 dark:bg-gray-800 w-3 h-3 rotate-45"
